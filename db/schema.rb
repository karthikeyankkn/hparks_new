...
ActiveRecord::Schema.define(version: 2018_10_30_070653) do
  ...
  create_table "linkdin_leads", force: :cascade do |t|
    t.string "name"
    t.string "email"
    t.string "phone_number"
  ...
  create_table "sitevisit_leads", force: :cascade do |t|
    t.string "name"
    t.string "email"
